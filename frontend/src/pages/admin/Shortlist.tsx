// frontend/src/pages/admin/Shortlist.tsx
...
export default function Shortlist() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error(error);
      alert("Failed to submit shortlist: " + error.message);
    } finally {
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 px-4 py-2.5 bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/20 rounded-xl shrink-0">
      ...
      <div className="bg-white dark:bg-[#0A0A12]/80 backdrop-blur-2xl border border-slate-200 dark:border-white/10 rounded-[2rem] shadow-xl shadow-slate-900/5 overflow-hidden">
        ...
        {data?.matches.length === 0 ? (
          <div className="p-8 text-center text-slate-500">
            No candidates matched the required criteria for this job.
          </div>
        ) : (
          <div
        ...
        <div className="p-6 border-t border-slate-200 dark:border-white/10 bg-slate-50/50 dark:bg-white/5 flex items-center justify-between">
          ...
          <button
            ...
            disabled={isSubmitting || data?.matches.length === 0}
