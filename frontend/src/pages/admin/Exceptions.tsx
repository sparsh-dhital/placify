  ...
  const [exceptions, setExceptions] = useState<ExceptionItem[]>([
    {
      ...
      severity: "high",
      resource: "Room 101",
      description: "Room delayed by 20 minutes due to technical setup issues.",
      impact: "3 interviews affected in the morning block.",
      recommendation:
        "Move affected interviews to Room 201 (Currently vacant).",
      confidence: 0.94,
      status: "pending",
    },
    {
      ...
      severity: "medium",
      resource: "Panel A",
      description: "Panel A is running 15 minutes late from previous briefing.",
      impact: "2 upcoming student sessions may experience rolling delays.",
      recommendation:
        "Shift subsequent interview slots by 15 minutes automatically.",
      confidence: 0.88,
      status: "pending",
    },
  ]);
